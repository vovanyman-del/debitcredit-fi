export const en = {
  ...
  home: {
    ...
    invisible: {
      ...
      lead: 'What others hide in paperwork is on your screen — an up-to-date view of your accountant’s work.',
  ...
  vaavo: {
    ...
    subtitle: 'A free client portal for our clients that makes following your finances easy and transparent.',
    free: 'Free for our clients',
    techHighlight: 'Vaavo combines bank data, document management and messaging in one place. AI helps your accountant by pre-reading receipts and speeding up the bookkeeping. Your bank, taxes and reports online — always up to date, anytime, anywhere.',
    cta: 'Want to see Vaavo in action?',
    features: {
      ai: { title: 'AI Receipt Processing', desc: 'AI reads your receipts and invoices and suggests the categorisation and matching bank transaction — your accountant reviews and confirms.' },
