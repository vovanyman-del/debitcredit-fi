export const en = {
  ...
  home: {
    hero: {
      ...
      subtitle: 'Bookkeeping, taxes and reporting under control. In the Vaavo client portal you see your bank, taxes and reports online — always up to date, no more «hand over the papers and wait».',
      cta: 'Free consultation',
      ctaSecondary: 'See Vaavo',
    },
    stats: {
      years: '10 years',
    ...
    heroCard: {
      ...
      live: 'LIVE',
      owner: 'Vladimir',
      ownerNote: 'Ready to pay — rent receipt received and recorded',
      turnover: 'Turnover',
      vat: 'ALV',
      result: 'Result',
      scan: 'Snap a receipt — it’s sent to your accountant for processing',
    },
    personas: {
    ...
    invisible: {
      ...
      lead: "Send sales invoices, receive supplier invoices, follow bank transactions and message your accountant in Vaavo. Our own client portal is included in the service at no extra charge.",
      bank: { title: 'Bank, taxes and reports — online', desc: 'Any time, without requesting a report or waiting.' },
      photo: { title: 'A photo of a receipt — straight to your accountant', desc: 'The snapshot is sent to your accountant for processing — no boxes of receipts.' },
    ...
    packages: {
      eyebrow: 'Pricing',
      title: 'Transparent. Vaavo in every package',
      subtitle: 'A guide by business size. We calculate the exact price during a consultation.',
      perMonth: ' / mo + ALV',
      popular: 'Popular',
      vaavoIncluded: 'Vaavo included',
      choose: 'Choose',
      viewAll: 'All packages',
      note: 'We’ll calculate the exact price — just write to us.',
    },
    team: {
      eyebrow: 'Team',
    ...
    testimonial: {
      ...
      author: 'Nikita',
      company: 'construction company Niki Rak',
    },
    finalCta: {
  ...
  pricing: {
    ...
    perMonth: ' / mo + ALV',
    vouchers: 'transactions / mo',
    extraVoucher: 'Extra transaction',
    ...
    packageFeatures: {
      ...
      basic: [
        ...
        '1 payroll run included (one employee/month)',
  ...
  vaavo: {
    ...
    subtitle: "Send sales invoices, receive supplier invoices and follow your company’s finances. Vaavo is included in Debit Credit’s bookkeeping service at no extra charge.",
    free: "Included in your service at no extra charge",
    techHighlight: "Vaavo is developed by Debit Credit. We use it ourselves every day and keep improving its features. The client portal is included in all our bookkeeping packages: no separate Vaavo subscription is needed, and using it does not increase your service price.",
    cta: 'Want to see Vaavo in action?',
    techTitle: "Built by us — for your everyday business",
    featuresTitle: "What you can do in Vaavo",
    productLink: "Explore Vaavo in more detail at vaavo.fi",
    features: {
      sales: { title: "Sales invoices", desc: "Create and send invoices and track outstanding and paid invoices directly in the client portal." },
      incoming: { title: "Supplier invoices", desc: "Receive and upload incoming invoices, view documents and send them to your accountant in one place." },
      ai: { title: "Smart document processing", desc: "AI reads receipts and invoices and suggests a category and matching bank transaction. Your accountant reviews and confirms the result." },
      bank: { title: 'Bank Connection', desc: 'Your bank data syncs automatically a few times a day. See income, expenses and balances at a glance.' },
    ...
    demo: {
      ...
      step3: { title: 'Snap a receipt — sent for processing', desc: 'The receipt goes straight to your accountant' },
  ...
  about: {
    ...
    story: {
      ...
      p3: 'We developed the Vaavo platform because we wanted to give our clients an always-up-to-date view of their finances — not just monthly reports, but a continuous connection to their bookkeeping.',
    },
    values: {
      title: 'Our Values',
      transparency: { title: 'Transparency', desc: 'Clear prices, open communication and online access to your financial data.' },
  ...
  contact: {
    ...
    form: {
      ...
      privacyNotice: 'By sending this form you agree that we process your data to handle your enquiry. See our Privacy Policy for details.',
    },
    info: {
      phone: 'Phone',
      email: 'Email',
  ...
  forAccountants: {
    ...
    intro: 'Vaavo is built for the way accountants work. The platform automates routine tasks, keeps bank data up to date and streamlines client communication.',
    ...
    features: {
      ...
      bank: { title: 'Bank Connections', desc: 'Bank data syncs automatically for all clients. Suggested transaction matching.' },
  ...
  switchAccountant: {
    ...
    benefits: {
      ...
      items: [
        ...
        'Vaavo client portal — your finances online, always up to date',
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: 'Transfers outside the EU/EEA', content: 'Some of our processors (e.g. Vercel and OpenAI) may process data outside the EU/EEA. Such transfers are protected by the EU Standard Contractual Clauses (SCCs) or by an adequacy decision of the European Commission.' },
      { title: 'Retention periods', content: 'Contact-form data is retained for up to 2 years. Bookkeeping material is retained under the Accounting Act (kirjanpitolaki): financial statements and accounting books for 10 years, and source documents (tositteet) for 6 years from the end of the year. We cannot erase data that we are legally required to retain before the retention period ends.' },
      { title: 'Data security', content: 'We protect personal data with appropriate technical and organisational measures, including access control, encryption of data in transit and the use of trusted processors.' },
      { title: 'Your rights', content: 'You have the right of access, the right to rectification, erasure, restriction of processing, data portability and objection, and the right to withdraw consent. We cannot erase data that we are legally required to keep (for example, bookkeeping material). To exercise your rights, contact vladimir@debitcredit.fi. You also have the right to lodge a complaint with the supervisory authority, the Office of the Data Protection Ombudsman (Tietosuojavaltuutetun toimisto, tietosuoja.fi).' },
      { title: 'Cookies', content: 'The site uses only technically necessary cookies (for language selection and basic functionality). We do not use analytics or tracking cookies. If this changes, we will ask for your consent.' },
    ],
  },
  terms: {
    ...
    sections: [
      ...
      { title: 'Service Description', content: 'Our services include bookkeeping, payroll, taxation, company formation and consulting. The Vaavo platform provides clients with access to their financial data. Personal data is processed as described in our Privacy Policy.' },
      { title: 'Pricing', content: 'Monthly packages are billed monthly in advance. Additional services are billed based on usage. All prices are exclusive of VAT (ALV) 25.5%.' },
  ...
  calc: {
    eyebrow: "Calculator",
    title: "Sole trader (toiminimi) tax calculator 2026: what you keep",
    subtitle: "Estimate a Finnish sole trader’s 2026 income taxes and YEL pension contributions and see how much of the profit you keep.",
    metaDescription: "Toiminimi tax calculator 2026: estimate state and municipal income tax, YEL and health insurance contributions and your take-home amount. Free.",
    profitLabel: "Annual profit of the toiminimi (€)",
    profitHint: "Sales minus expenses, excluding VAT, before your own YEL contributions.",
    yelLabel: "YEL income (YEL-työtulo), € per year",
    yelHint: "Stated in your YEL insurance. YEL is compulsory when this income is at least €9,423.09 a year (2026). If you have no YEL insurance, enter 0.",
    starterLabel: "First-time entrepreneur (22% YEL discount for the first 4 years)",
    municipalLabel: "Municipal tax rate (%)",
    municipalHint: "7.60% is the average municipal income tax rate in 2026. You can find your municipality’s rate on the Tax Administration’s website.",
    churchLabel: "Church tax rate (%)",
    churchHint: "Only if you belong to the Evangelical Lutheran or Orthodox Church of Finland; otherwise 0.",
    resultTitle: "Estimate for 2026",
    rowYel: "YEL contribution",
    rowState: "State income tax (after the work income deduction)",
    rowMunicipal: "Municipal tax",
    rowChurch: "Church tax",
    rowHealth: "Health insurance contributions",
    rowYle: "Public broadcasting tax (Yle)",
    rowTotal: "Taxes and contributions in total",
    netYear: "You keep per year",
    netMonth: "per month",
    share: "Taxes and YEL as a share of profit",
    belowMinYel: "The YEL income is below the minimum of €9,423.09, so the estimate is made without YEL insurance.",
    assumptionsTitle: "What the calculator assumes",
    assumptions: [
      "You have no other income and the business has no net assets, so the whole profit is taxed as earned income.",
      "YEL contributions are deducted from the business profit, and then the 5% entrepreneur deduction (yrittäjävähennys) is applied.",
      "You are 18–64, live in mainland Finland (not Åland) all year, have no children under 18 and claim no other deductions.",
      "This is an estimate based on the 2026 tax rules. The final tax is set by the Tax Administration (Vero).",
    ],
    ctaTitle: "Want an exact calculation?",
    ctaText: "We calculate your prepayment tax (ennakkovero) correctly, help with YEL and keep your toiminimi’s books. Our accountants serve you in Finnish or Russian.",
    ctaButton: "Contact us",
    sourcesTitle: "Sources",
    srcTaxBases: "Vero: calculation bases for withholding and prepayment tax 2026 (in Finnish)",
    srcScale: "Vero: state income tax schedule 2026 (in Finnish)",
    srcMunicipal: "Vero: municipal and parish tax rates 2026 (in Finnish)",
    srcYel: "Finnish Centre for Pensions: pension contributions in 2026 (in Finnish)",
    hubCardTitle: "Toiminimi tax calculator 2026",
    hubCardDesc: "Work out how much of a sole trader’s profit goes to taxes and YEL and how much you keep.",
    hubCardCta: "Open the calculator",
  },
  common: {
