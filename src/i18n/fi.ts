export const fi = {
  ...
  home: {
    ...
    invisible: {
      ...
      lead: "Lähetä myyntilaskuja, vastaanota ostolaskuja, seuraa pankkitapahtumia ja viesti kirjanpitäjäsi kanssa Vaavossa. Itse kehittämämme asiakasportaali sisältyy palveluun ilman lisämaksua.",
  ...
  vaavo: {
    ...
    subtitle: "Lähetä myyntilaskuja, vastaanota ostolaskuja ja seuraa yrityksesi taloutta. Vaavo sisältyy Debit Creditin kirjanpitopalveluun ilman lisämaksua.",
    free: "Sisältyy palveluun ilman lisämaksua",
    techHighlight: "Vaavo on Debit Creditin kehittämä alusta. Käytämme sitä itse päivittäin ja kehitämme sen ominaisuuksia jatkuvasti. Asiakasportaali sisältyy kaikkiin kirjanpitopaketteihimme: et tarvitse erillistä Vaavo-tilausta, eikä portaali korota palvelusi hintaa.",
    cta: 'Haluatko nähdä Vaavon toiminnassa?',
    techTitle: "Oma kehitystyömme — yrityksesi arkeen",
    featuresTitle: "Mitä voit tehdä Vaavossa",
    productLink: "Tutustu Vaavoon tarkemmin osoitteessa vaavo.fi",
    features: {
      sales: { title: "Myyntilaskut", desc: "Laadi ja lähetä laskuja sekä seuraa avoimia ja maksettuja laskuja suoraan asiakasportaalissa." },
      incoming: { title: "Ostolaskut", desc: "Vastaanota ja lataa ostolaskuja, tarkastele asiakirjoja ja toimita ne kirjanpitäjälle samassa palvelussa." },
      ai: { title: "Tositteiden älykäs käsittely", desc: "Tekoäly tunnistaa kuitit ja laskut sekä ehdottaa kirjauskategoriaa ja vastaavaa pankkitapahtumaa. Kirjanpitäjä tarkastaa ja vahvistaa lopputuloksen." },
  ...
  calc: {
    eyebrow: "Laskuri",
    title: "Toiminimen verolaskuri 2026: paljonko jää käteen?",
    subtitle: "Arvioi toiminimen verot ja YEL-maksut vuodelle 2026 ja näe, paljonko tuloksesta jää sinulle.",
    metaDescription: "Toiminimen verolaskuri 2026: arvioi valtion tulovero, kunnallisvero, YEL-maksu ja sairausvakuutusmaksut ja näe, paljonko jää käteen. Ilmainen laskuri.",
    profitLabel: "Toiminimen tulos vuodessa (€)",
    profitHint: "Myynti miinus kulut ilman arvonlisäveroa, ennen omia YEL-maksuja.",
    yelLabel: "YEL-työtulo (€ vuodessa)",
    yelHint: "Työtulo on vahvistettu YEL-vakuutuksessasi. YEL on pakollinen, kun työtulo on vähintään 9 423,09 € vuodessa (2026). Jos sinulla ei ole YEL-vakuutusta, kirjoita 0.",
    starterLabel: "Aloittava yrittäjä (YEL-maksusta 22 %:n alennus ensimmäiset 4 vuotta)",
    municipalLabel: "Kunnallisveroprosentti (%)",
    municipalHint: "7,60 % on kuntien keskimääräinen tuloveroprosentti 2026. Oman kuntasi prosentin löydät Verohallinnon sivuilta.",
    churchLabel: "Kirkollisveroprosentti (%)",
    churchHint: "Vain jos kuulut evankelis-luterilaiseen tai ortodoksiseen kirkkoon; muuten 0.",
    resultTitle: "Arvio vuodelle 2026",
    rowYel: "YEL-maksu",
    rowState: "Valtion tulovero (työtulovähennyksen jälkeen)",
    rowMunicipal: "Kunnallisvero",
    rowChurch: "Kirkollisvero",
    rowHealth: "Sairausvakuutusmaksut",
    rowYle: "Yleisradiovero",
    rowTotal: "Verot ja maksut yhteensä",
    netYear: "Jää käteen vuodessa",
    netMonth: "kuukaudessa",
    share: "Verojen ja YEL-maksujen osuus tuloksesta",
    belowMinYel: "YEL-työtulo on alle vähimmäistason 9 423,09 €, joten laskelma tehdään ilman YEL-vakuutusta.",
    assumptionsTitle: "Mitä laskuri olettaa",
    assumptions: [
      "Sinulla ei ole muita tuloja eikä yrityksellä ole nettovarallisuutta, joten koko tulos verotetaan ansiotulona.",
      "YEL-maksut vähennetään yrityksen tuloksesta, minkä jälkeen tuloksesta tehdään 5 %:n yrittäjävähennys.",
      "Olet 18–64-vuotias ja asut koko vuoden Manner-Suomessa (et Ahvenanmaalla), sinulla ei ole alaikäisiä lapsia etkä tee muita vähennyksiä.",
      "Laskelma on arvio vuoden 2026 veroperusteilla. Lopullisen veron määrää Verohallinto.",
    ],
    ctaTitle: "Haluatko tarkan laskelman?",
    ctaText: "Laskemme ennakkoveron oikein, hoidamme YEL-asiat ja toiminimen kirjanpidon. Palvelemme suomeksi ja venäjäksi.",
    ctaButton: "Ota yhteyttä",
    sourcesTitle: "Lähteet",
    srcTaxBases: "Verohallinto: ennakonpidätyksen ja ennakkoveron laskentaperusteet 2026",
    srcScale: "Verohallinto: valtion tuloveroasteikko 2026",
    srcMunicipal: "Verohallinto: kuntien ja seurakuntien tuloveroprosentit 2026",
    srcYel: "Eläketurvakeskus: työeläkemaksut vuonna 2026",
    hubCardTitle: "Toiminimen verolaskuri 2026",
    hubCardDesc: "Laske, paljonko toiminimen tuloksesta menee veroihin ja YEL-maksuihin ja paljonko jää käteen.",
    hubCardCta: "Avaa laskuri",
  },
  common: {
