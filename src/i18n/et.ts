export const et = {
  ...
  home: {
    ...
    heroCard: {
      ...
      live: 'LIVE',
      owner: 'Vladimir',
      ownerNote: 'Valmis maksma — üürikviitung saabunud ja kirjendatud',
      turnover: 'Käive',
      vat: 'ALV',
      result: 'Tulem',
      scan: 'Pildista kviitung — kirjendub ise',
    },
    personas: {
  ...
  vaavo: {
    ...
    features: {
      ai: { title: 'AI kviitungite töötlus', desc: 'Tehisintellekt tuvastab automaatselt kviitungid ja arved, soovitab kategooriat ja seob need pangatehingutega.' },
    ...
    demo: {
      ...
      step3: { title: 'Pildista kviitung — valmis', desc: 'Kviitung saadetakse automaatselt raamatupidajale' },
