export const et = {
  ...
  home: {
    ...
    personas: {
      ...
      opening: { title: 'Asutan ettevõtte', desc: 'Nullist valime vormi, registreerime ja selgitame iga sammu — ilma raamatupidamisžargoonita.', cta: 'Alusta vestlusest' },
