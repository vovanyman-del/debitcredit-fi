...
export const palkanlaskenta: Guide = {
  ...
  content: {
      ...
      body: [
        ...
        { t: 'note', x: 'Maksuprosentit muuttuvat vuosittain ja osa riippuu palkkasummasta ja toimialasta. Käytä noin 20 %:a suuntaa-antavana ja varmista ajantasaiset luvut.' },
    ...
    ru: {
      ...
      body: [
        ...
        { t: 'note', x: 'Проценты взносов меняются ежегодно, часть зависит от суммы зарплат и отрасли. Используйте ~20 % как ориентир и уточняйте актуальные цифры.' },
        ...
        { t: 'ul', items: [
          ...
          'Гигиена труда — работодатель обязан организовать профилактическое медобслуживание.',
    ...
    en: {
      ...
      body: [
        ...
        { t: 'note', x: 'The contribution rates change every year and some depend on the payroll size and industry. Use about 20% as a guide and confirm the current figures.' },
    ...
    et: {
      ...
      body: [
        ...
        { t: 'note', x: 'Maksumäärad muutuvad igal aastal ja osa sõltub palgasummast ja tegevusalast. Kasuta umbes 20 % orientiirina ja kontrolli ajakohaseid numbreid.' },
    ...
    uk: {
      ...
      body: [
        ...
        { t: 'note', x: 'Відсотки внесків змінюються щороку, частина залежить від суми зарплат і галузі. Використовуйте ~20 % як орієнтир і уточнюйте актуальні цифри.' },
        ...
        { t: 'ul', items: [
          ...
          'Гігієна праці — роботодавець зобовʼязаний організувати профілактичне медобслуговування.',
