...
export const ennakkovero: Guide = {
  ...
  content: {
      ...
      body: [
        ...
        { t: 'note', x: 'Korot ja eräpäivät vahvistetaan vuosittain. Varmista ajantasaiset tiedot OmaVerosta tai kirjanpitäjältä.' },
        ...
        { t: 'p', x: 'Arvioimme tuloksesi ja pidämme ennakkoveron ajan tasalla, jotta vältät yllätykset ja korot — omalla kielelläsi. Näet tilanteesi reaaliajassa Vaavossa.' },
      ],
      faq: [
    ...
    ru: {
      ...
      body: [
        ...
        { t: 'note', x: 'Проценты и сроки уплаты подтверждаются ежегодно. Уточняйте актуальные данные в OmaVero или у бухгалтера.' },
        ...
        { t: 'p', x: 'Оценим вашу прибыль и будем держать авансовый налог в актуальном состоянии, чтобы вы избежали сюрпризов и процентов — на вашем языке. Ситуацию вы видите в реальном времени в Vaavo.' },
      ],
      faq: [
    ...
    en: {
      ...
      body: [
        ...
        { t: 'note', x: 'Interest rates and due dates are set yearly. Confirm the current details in OmaVero or with an accountant.' },
        ...
        { t: 'p', x: 'We estimate your profit and keep the prepaid tax up to date so you avoid surprises and interest — in your language. You see your situation in real time in Vaavo.' },
      ],
      faq: [
    ...
    et: {
      ...
      body: [
        ...
        { t: 'note', x: 'Intressid ja maksetähtajad kinnitatakse igal aastal. Kontrolli ajakohaseid andmeid OmaVeros või raamatupidajalt.' },
        ...
        { t: 'p', x: 'Hindame su kasumit ja hoiame ettemaksu ajakohasena, et väldiksid üllatusi ja intresse — sinu keeles. Oma olukorda näed reaalajas Vaavos.' },
      ],
      faq: [
    ...
    uk: {
      ...
      body: [
        ...
        { t: 'note', x: 'Відсотки та терміни сплати підтверджуються щороку. Уточнюйте актуальні дані в OmaVero або в бухгалтера.' },
        ...
        { t: 'p', x: 'Оцінимо ваш прибуток і триматимемо авансовий податок в актуальному стані, щоб ви уникнули сюрпризів і відсотків — вашою мовою. Ситуацію ви бачите в реальному часі у Vaavo.' },
      ],
      faq: [
